...
<div style="text-align: center;">
    <img src="coder_buddy_diagram.png" alt="Coder Agent Architecture" width="90%"/>
</div>
...
- Create a virtual environment using: ` python -m venv .venv` and activate it using ` .venv/Scripts/activate`
- Install the dependencies using: ` pip install .`
- Create a `.env` file and add the variables a
